...
let JSONStream = Meteor.npmRequire('JSONStream');
Router.route('/datasets/:dsId/distributions/:_id', function () {
    ...
    Meteor.call('mongodbConnect', distId, function (error, result) {
        Meteor.call(method, distId, collection, selector, options, function (error, result) {
